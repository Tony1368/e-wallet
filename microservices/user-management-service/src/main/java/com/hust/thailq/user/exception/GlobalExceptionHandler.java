package com.hust.thailq.user.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
                                                                  ...
                                                                  WebRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.UNPROCESSABLE_ENTITY.value(), messageConfig.getMessage(MessageKeys.ERROR_VALIDATION));
        for (FieldError fieldError : ex.getBindingResult().getFieldErrors()) {
            errorResponse.addValidationError(fieldError.getField(), fieldError.getDefaultMessage());
        }
        log.error(messageConfig.getMessage(MessageKeys.ERROR_METHOD_ARGUMENT, ex));
    ...
    public ResponseEntity<Object> handleNoSuchElementFoundException(NoSuchElementFoundException ex, WebRequest request) {
        log.error(messageConfig.getMessage(MessageKeys.ERROR_NOT_FOUND, ex));
    ...
    public ResponseEntity<Object> handleElementAlreadyExistsException(ElementAlreadyExistsException ex, WebRequest request) {
        log.error(messageConfig.getMessage(MessageKeys.ERROR_ALREADY_EXISTS, ex));
    ...
    public ResponseEntity<Object> handleAuthenticationException(AuthenticationException ex, WebRequest request) {
        log.error(messageConfig.getMessage(MessageKeys.ERROR_UNAUTHORIZED_DETAILS, ex));
    ...
    public ResponseEntity<Object> handleConstraintValidationException(ConstraintViolationException ex, WebRequest request) {
        log.warn(messageConfig.getMessage(MessageKeys.ERROR_FIELD_VALIDATION, ex));
