...
class WalletServiceTest {
    ...
    void create_shouldCreateNewWallet() {
        ...
        when(transactionService.create(any(TransactionRequest.class))).thenReturn(CommandResponse.builder().id(1L).build());
    ...
    void transferFunds_shouldTransferFundsBetweenWallets() {
        ...
        when(transactionService.create(request)).thenReturn(CommandResponse.builder().id(1L).build());
