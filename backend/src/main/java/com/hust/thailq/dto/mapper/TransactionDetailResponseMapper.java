...
/**
 * Mapper used for mapping TransactionDetailResponse fields.
 */
...
public interface TransactionDetailResponseMapper {
    ...
    TransactionDetailResponse toDto(Transaction entity);

    @AfterMapping
    default void formatCreatedAtAndType(@MappingTarget TransactionDetailResponse dto, Transaction entity) {
